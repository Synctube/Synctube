...
function _timeBatch (delay, func) {
	var batch = [];
	var timer = null;
	return function () {
		var args = [];
...
module.exports = exports = {
	...
	getVideoLength: _timeBatch(config.youtube.batchDelay, function (reqs) {
	...
	getVideoSnippet: _timeBatch(config.youtube.batchDelay, function (reqs) {
		var ids = _groupCalls(reqs);
